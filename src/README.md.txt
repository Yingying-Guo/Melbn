...
3.Test if the JDK is installed successfully "Start" -> "Run", type "cmd" 
	...
	C:\Users\bagoo>java -version java version "17.0.2" 2022-01-18 LTS Java(TM) SE Runtime Environment (build 17.0.2+8-LTS-86) Java HotSpot(TM) 64-Bit Server VM (build 17.0.2+8-LTS-86, mixed mode, sharing)
